...
def find_operations_by_description(operations: list) -> list:
    user_str = input("Введите название банковской операции: ")
    res_list = []
    for i in operations:
        for k, v in i.items():
            if k == "description" and re.findall(user_str.lower(), v.lower()):
                res_list.append(i)
...
if __name__ == '__main__':
   # print(find_operations_by_description(get_transactions_from_csv(transactions_path)))
